...
Adapted from DeerFlow: runs at ``abefore_agent``, reads memory directly from
JSON storage via ``get_memory_data()`` + ``format_memory_for_injection()``.
...
Date-update format (midnight crossing):
    ...
    <system-reminder>
    <current_date>2026-06-24, Wednesday</current_date>
    </system-reminder>
"""
